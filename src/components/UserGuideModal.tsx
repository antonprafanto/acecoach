  ...
  return (
    <div className="fixed inset-0 z-50 bg-tennis-dark/90 backdrop-blur-md flex items-center justify-center p-3 sm:p-4 animate-in fade-in duration-200">
      <div className="bg-tennis-surface border border-slate-700/80 max-w-lg w-full rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
        {/* Header */}
        <div className="p-4 sm:p-5 border-b border-slate-800 flex items-center justify-between bg-tennis-navy/60">
        ...
        {/* Step Selector Tabs */}
        <div className="grid grid-cols-4 p-2 bg-slate-900/80 border-b border-slate-800 gap-1 text-xs">
          {guideSteps.map((step) => {
        ...
        {/* Footer Navigation */}
        <div className="p-3 sm:p-4 border-t border-slate-800 bg-tennis-navy/80 flex items-center justify-between gap-2">
          {activeStep > 1 ? (
            <button
