    ...
    case 'b_w1_grip':
      return (
        <div className="bg-[#070D18] border border-slate-700/80 rounded-xl p-3 flex flex-col items-center justify-center my-2">
          ...
          <svg viewBox="0 0 220 180" className="w-52 h-40" style={mirrorStyle}>
            {/* Octagonal Handle */}
            <polygon
    ...
    case 'b_w1_contact_point':
      return (
        <div className="bg-[#070D18] border border-slate-700/80 rounded-xl p-3 flex flex-col items-center justify-center my-2">
          ...
          <svg viewBox="0 0 240 150" className="w-56 h-36" style={mirrorStyle}>
            {/* Player Body */}
    ...
    case 'b_w2_unit_turn':
      return (
        <div className="bg-[#070D18] border border-slate-700/80 rounded-xl p-3 flex flex-col items-center justify-center my-2">
          ...
          <svg viewBox="0 0 200 140" className="w-52 h-34" style={mirrorStyle}>
            {/* Torso Top View */}
    ...
    case 'b_w3_forehand_drop':
      return (
        <div className="bg-[#070D18] border border-slate-700/80 rounded-xl p-3 flex flex-col items-center justify-center my-2">
          ...
          <svg viewBox="0 0 220 140" className="w-52 h-34" style={mirrorStyle}>
            {/* Ball Incoming Line */}
    ...
    case 'b_w4_serve_trophy':
      return (
        <div className="bg-[#070D18] border border-slate-700/80 rounded-xl p-3 flex flex-col items-center justify-center my-2">
          ...
          <svg viewBox="0 0 200 160" className="w-48 h-38" style={mirrorStyle}>
            {/* Player Silhouette */}
    ...
    case 'i_w1_open_stance_forehand':
      return (
        <div className="bg-[#070D18] border border-slate-700/80 rounded-xl p-3 flex flex-col items-center justify-center my-2">
          ...
          <svg viewBox="0 0 220 150" className="w-52 h-36" style={mirrorStyle}>
            {/* Ground */}
